...
We welcome contributions to `quarto-focus-list`. You can either:

## Reporting Issues

If you find a bug or have a feature request, please [open an issue](https://github.com/bergam0t/quarto-focus-list/issues) and include:
...
2. **Make your changes** to the Lua filter (`focus-list.lua`). If you need to add a stylesheet, take a look at how this is handled in https://github.com/bergam0t/quarto-value-box.
...
- Keep the filter self-contained in `focus-list.lua` — avoid introducing external Lua dependencies.
